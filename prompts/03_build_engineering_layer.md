# Prompt 03: Build The Engineering Layer

Use `product-engineering-ops` and `obsidian-intelligence-system`.

Extend the vault into an engineering operating surface for this manifest:
`/absolute/path/to/product.yaml`

Focus on:
- code and repo intelligence
- route, schema/data-model, call graph, dependency graph, test coverage, ownership, and churn maps
