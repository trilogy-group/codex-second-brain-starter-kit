    ...
    return {
        ...
        "engineering_readiness": {
            "categories": [
                ...
                {
                    "key": "product-basb-alignment",
                    "title": "Product BASB alignment",
                    "ask": 4,
                    "status": "missing",
                    "summary": "Describe how well the vault applies CODE, PARA, progressive summarization, intermediate packets, and archive hygiene.",
                    "evidence": [],
                    "missing": ["CODE/PARA dashboards, BASB frontmatter, and archive/output loops have not been verified yet."],
                    "next_steps": ["Review the Product BASB hubs and audit results after the first rebuild."],
                },
                {
                    "key": "progressive-summarization-coverage",
                    "title": "Progressive summarization coverage",
                    "ask": 5,
                    "status": "missing",
                    "summary": "Describe how much raw evidence has concise essence, actionability, and reusable intermediate packets.",
                    "evidence": [],
                    "missing": ["Raw notes have not yet been distilled into essence/action sections and reusable packets."],
                    "next_steps": ["Promote high-value raw evidence into distilled notes and intermediate packets."],
                },
                {
                ...
                {
                    "key": "output-conversion-and-archive-hygiene",
                    "title": "Output conversion and archive hygiene",
                    "ask": 10,
                    "status": "missing",
                    "summary": "Describe whether distilled intelligence turns into shippable outputs and completed work is archived with reusable learnings.",
                    "evidence": [],
                    "missing": ["No output pipeline, project closeout, or archive review evidence has been captured yet."],
                    "next_steps": ["Create output candidates for high-value findings and archive completed initiatives with closeout notes."],
                },
                {
